...
public class DiscussionResponse extends org.apache.thrift.TUnion<DiscussionResponse, DiscussionResponse._Fields> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("DiscussionResponse");
  ...
  static {
    ...
    tmpMap.put(_Fields.RESPONSE, new org.apache.thrift.meta_data.FieldMetaData("response", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
        new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, DiscussionApiResponse.class)));
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(DiscussionResponse.class, metaDataMap);
  }
  ...
  public DiscussionResponse(_Fields setField, java.lang.Object value) {
    super(setField, value);
  }

  public DiscussionResponse(DiscussionResponse other) {
    super(other);
  }
  @Override
  public DiscussionResponse deepCopy() {
    return new DiscussionResponse(this);
  }

  public static DiscussionResponse response(DiscussionApiResponse value) {
    DiscussionResponse x = new DiscussionResponse();
    x.setResponse(value);
    return x;
  }

  public static DiscussionResponse error(DiscussionNativeError value) {
    DiscussionResponse x = new DiscussionResponse();
    x.setError(value);
    return x;
  }
  ...
  protected void checkType(_Fields setField, java.lang.Object value) throws java.lang.ClassCastException {
    switch (setField) {
      case RESPONSE:
        if (value instanceof DiscussionApiResponse) {
          break;
        }
        throw new java.lang.ClassCastException("Was expecting value of type DiscussionApiResponse for field 'response', but got " + value.getClass().getSimpleName());
      case ERROR:
      ...
      switch (setField) {
        case RESPONSE:
          if (field.type == RESPONSE_FIELD_DESC.type) {
            DiscussionApiResponse response;
            response = new DiscussionApiResponse();
            response.read(iprot);
            return response;
          } else {
  ...
  protected void standardSchemeWriteValue(org.apache.thrift.protocol.TProtocol oprot) throws org.apache.thrift.TException {
    switch (setField_) {
      case RESPONSE:
        DiscussionApiResponse response = (DiscussionApiResponse)value_;
  ...
  public DiscussionApiResponse getResponse() {
    if (getSetField() == _Fields.RESPONSE) {
      return (DiscussionApiResponse)getFieldValue();
    } else {
  ...
  public void setResponse(DiscussionApiResponse value) {
  ...
  public boolean equals(java.lang.Object other) {
    if (other instanceof DiscussionResponse) {
      return equals((DiscussionResponse)other);
    } else {
      return false;
    }
  }

  public boolean equals(DiscussionResponse other) {
    return other != null && getSetField() == other.getSetField() && getFieldValue().equals(other.getFieldValue());
  }

  @Override
  public int compareTo(DiscussionResponse other) {
