...
public class AddUsernameResponse extends org.apache.thrift.TUnion<AddUsernameResponse, AddUsernameResponse._Fields> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("AddUsernameResponse");
  ...
  static {
    ...
    tmpMap.put(_Fields.RESPONSE, new org.apache.thrift.meta_data.FieldMetaData("response", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
        new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, AddUsernameApiResponse.class)));
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(AddUsernameResponse.class, metaDataMap);
  }
  ...
  public AddUsernameResponse(_Fields setField, java.lang.Object value) {
    super(setField, value);
  }

  public AddUsernameResponse(AddUsernameResponse other) {
    super(other);
  }
  @Override
  public AddUsernameResponse deepCopy() {
    return new AddUsernameResponse(this);
  }

  public static AddUsernameResponse response(AddUsernameApiResponse value) {
    AddUsernameResponse x = new AddUsernameResponse();
    x.setResponse(value);
    return x;
  }

  public static AddUsernameResponse error(DiscussionNativeError value) {
    AddUsernameResponse x = new AddUsernameResponse();
    x.setError(value);
    return x;
  }
  ...
  protected void checkType(_Fields setField, java.lang.Object value) throws java.lang.ClassCastException {
    switch (setField) {
      case RESPONSE:
        if (value instanceof AddUsernameApiResponse) {
          break;
        }
        throw new java.lang.ClassCastException("Was expecting value of type AddUsernameApiResponse for field 'response', but got " + value.getClass().getSimpleName());
      case ERROR:
      ...
      switch (setField) {
        case RESPONSE:
          if (field.type == RESPONSE_FIELD_DESC.type) {
            AddUsernameApiResponse response;
            response = new AddUsernameApiResponse();
            response.read(iprot);
            return response;
          } else {
  ...
  protected void standardSchemeWriteValue(org.apache.thrift.protocol.TProtocol oprot) throws org.apache.thrift.TException {
    switch (setField_) {
      case RESPONSE:
        AddUsernameApiResponse response = (AddUsernameApiResponse)value_;
  ...
  public AddUsernameApiResponse getResponse() {
    if (getSetField() == _Fields.RESPONSE) {
      return (AddUsernameApiResponse)getFieldValue();
    } else {
  ...
  public void setResponse(AddUsernameApiResponse value) {
  ...
  public boolean equals(java.lang.Object other) {
    if (other instanceof AddUsernameResponse) {
      return equals((AddUsernameResponse)other);
    } else {
      return false;
    }
  }

  public boolean equals(AddUsernameResponse other) {
    return other != null && getSetField() == other.getSetField() && getFieldValue().equals(other.getFieldValue());
  }

  @Override
  public int compareTo(AddUsernameResponse other) {
