...
//tasks.register<Exec>("generateThriftClasses") {
//    executable = "thrift"
//    args?.plusAssign(
//        listOf(
//            "-out",
...
//            "src/main/thrift/native.thrift",
//        ),
//    )
//}


//thrift -out src/main/java/ -gen java:generated_annotations=undated library/src/main/thrift/native.thrift